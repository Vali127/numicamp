...
export const AdminResource = () => {
    const { currentTab, setCurrentTab, data, setData, list, deletionModal, setDeletionModal, formResult, sendData, domains } = AdminRessourceViewModel()

    return (
        <div className="text-left">
            <ResourceTab currentTab={currentTab} setCurrentTab={setCurrentTab} />
            <div>
                { (currentTab === "form") && <ResourceForm data={data} setData={setData} result={formResult} action={sendData} domains={domains} /> }
