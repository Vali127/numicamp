...
export const PasswordForm = ({CurrentPage, isButtonNextDisabled}) => {
    ...
    const { error, CheckPasswordValidity, passwordError, HandleInputPassword, accountForm, passwordVisibility1, passwordVisibility2, HandlePasswordVisibility1, HandlePasswordVisibility2 } = PasswordViewModel()
    ...
    return (
        <div className={" text-left mx-20"}>
            <p className={"font-bold text-2xl"}>Choisissez un <span>mot de passe</span></p>
